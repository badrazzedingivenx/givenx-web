        ...
        <div className="contact-grid">
          ...
          <div className={`contact-info-panel ${isFormVisible ? 'anim-slide-up' : ''}`} style={{ animationDelay: '0.2s' }}>
            ...
            <div className="availability-card">
              ...
              <a href="https://wa.me/212635166074?text=Bonjour%20GivenX%20Tech,%20je%20souhaite%20avoir%20plus%20d'informations%20sur%20vos%20services." target="_blank" rel="noreferrer" className="whatsapp-btn">
      ...
      <footer className="slim-footer">
        <div className="slim-footer-content">
          ...
          <div className="slim-footer-links">
            ...
            <a href="mailto:contact@givenxtech.com">contact@givenxtech.com</a>
            <a href="tel:+212635166074">+212 635 166 074</a>
          </div>
        </div>
      </footer>
    </div>
